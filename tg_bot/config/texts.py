...
Enter role name (English only):""",
    ...
    'jira_user_not_found': "ℹ️  Пользователь с Jira аккаунтом '{jira_account}' не найден в системе.\nБудет создан новый профиль.",
    'jira_user_already_registered': "⚠️  Пользователь с Jira аккаунтом '{jira_account}' уже зарегистрирован в Telegram.\nЕсли это вы, используйте /start с тем же Telegram аккаунтом.",
